...
.logboektitel {
    ...
    line-height:39px;
    font-size:24px;
    background-image: url('http://bhccomp.dev/wp-content/themes/twentyfifteen/slaaplogboek/Slaapmakend_logo.png');
...
<form name="form1" method="post" action="<?php echo get_template_directory_uri() . '/slaaplogboek/checklogin.php' ;?>">
	<p>
