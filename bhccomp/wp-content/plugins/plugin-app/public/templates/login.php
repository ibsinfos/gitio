...
<!--        <script type="text/javascript">
    ...
    <body class="login">
        <div id="login">
            ...
            <form name="form1" method="post" action="<?php echo plugin_dir_url(__FILE__); ?>checklogin.php">
                <p>
            ...
            <p id="nav">
                <a href="<?php echo plugin_dir_url(__FILE__) . 'register/register.php'; ?>">Registreren</a> |
