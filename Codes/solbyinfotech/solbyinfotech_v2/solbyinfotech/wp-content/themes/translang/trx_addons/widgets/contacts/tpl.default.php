	...
	if (!empty($address) || !empty($phone) || !empty($email)) {
		?><div class="contacts_info"><?php
			if (!empty($address)) {
				...
				?>
				<label>Address:</label>
				<span class="contacts_address"><?php echo str_replace('|', "<br>", $address); ?></span>
				<?php
				if ($columns) {
					?></div><?php
				}
			...
			if (!empty($phone) || !empty($email)) {
				...
				if (!empty($phone)) {
					?>
					<label>Phone:</label>
					<span class="contacts_phone"><?php echo wp_kses_data($phone); ?></span>
					<?php
				}
				if (!empty($email)) {
					?>
					<label>E-mail:</label>
					<span class="contacts_email"><a href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email); ?></a></span>
					<?php
				}
				if ($columns) {
					?></div><?php
