...
if (!function_exists('translang_trx_addons_theme_setup9')) {
	...
	function translang_trx_addons_theme_setup9() {
		if (translang_exists_trx_addons()) {
			...
			if (is_admin()) {
				add_filter( 'translang_filter_allow_meta_box', 			'translang_trx_addons_allow_meta_box', 10, 2);
...
if (!function_exists('translang_trx_addons_allow_meta_box')) {
	//Handler of the add_filter( 'translang_filter_allow_meta_box', 'translang_trx_addons_allow_meta_box', 10, 2);
	function translang_trx_addons_allow_meta_box($allow, $post_type) {
		return $allow
