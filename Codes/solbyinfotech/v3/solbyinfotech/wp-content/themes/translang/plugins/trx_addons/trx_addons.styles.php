...
if (!function_exists('translang_trx_addons_get_css')) {
	add_filter('translang_filter_get_css', 'translang_trx_addons_get_css', 10, 4);
	function translang_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.top_panel .sc_layouts_row_fixed_on .sc_layouts_item .sc_item_title {
	// color: {$colors['text_dark']};
}
.top_panel .sc_layouts_row  .sc_layouts_item:last-child .sc_button:hover {
	// color: {$colors['text_dark']}!important;
}
.top_panel .sc_layouts_row  .sc_layouts_item .trx_addons_login_link {
	color: {$colors['bg_color']};
}
.top_panel .sc_layouts_row  .sc_layouts_item .trx_addons_login_link:hover {
	color: {$colors['text_link']};
}
.top_panel .sc_layouts_row_fixed_on .sc_layouts_item .trx_addons_login_link {
	// color: {$colors['text_dark']};
}

/* Row type: Narrow */
.sc_layouts_row.sc_layouts_row_type_narrow .sc_layouts_item_details_line1 {
	color: {$colors['bg_color']};
}
...
.scheme_self.sc_layouts_row.sc_layouts_row_type_narrow.sc_layouts_row_fixed_on {
...
.sc_layouts_row.sc_layouts_row_type_narrow.sc_layouts_row_fixed_on .sc_layouts_item_icon {
	color: {$colors['bg_color']};
}
...
.sc_layouts_row_fixed_on.sc_layouts_row_type_narrow .sc_layouts_item_details_line1,
.sc_layouts_row_fixed_on.sc_layouts_row_type_narrow .sc_layouts_item_details_line2,
.sc_layouts_row_fixed_on.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_details_line1,
.sc_layouts_row_fixed_on.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_details_line2 {
	// color: {$colors['text_dark']};
}
.top_panel .sc_layouts_item .sc_layouts_iconed_text.sc_layouts_menu_mobile_button .sc_layouts_item_icon {
	color: {$colors['text_link']};
}
.top_panel .sc_layouts_item .sc_layouts_iconed_text .sc_layouts_item_icon {
	// color: {$colors['bg_color']};
}
.top_panel .sc_layouts_row_fixed_on .sc_layouts_item .sc_layouts_iconed_text .sc_layouts_item_icon {
	// color: {$colors['text_dark']};
}
...
.sc_layouts_row_type_narrow .sc_button_wrap .sc_button_default,
.sc_layouts_row_type_narrow .sc_button_wrap .sc_button:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image){
	// background-color: transparent;
	// border-color: {$colors['alter_link']};
	background-color: {$colors['text_link']};
	color: {$colors['bg_color']};
}
.sc_layouts_row_type_narrow .sc_button_wrap .sc_button_default:hover,
.sc_layouts_row_type_narrow .sc_button_wrap .sc_button:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
...
.sc_layouts_row_fixed_on.sc_layouts_row_type_compact .search_wrap .search_submit,
.sc_layouts_row_fixed_on.scheme_self.sc_layouts_row_type_compact .search_wrap .search_submit {
	background-color: transparent;
	color: {$colors['text_dark']};
}
...
.top_panel .scheme_self .sc_layouts_title h1{
	color: {$colors['text_dark']};
}
...
/* Menu */
.sc_layouts_menu_nav > li > a:not(.trx_addons_icon-dot3) {
	color: {$colors['alter_dark']};
}
...
.sc_form.sc_form_detailed .sc_form_info .sc_form_info_area_place a {
	color: {$colors['text_dark']};
}
.sc_form.sc_form_detailed .sc_form_info .sc_form_info_area_place a:hover {
	color: {$colors['text_link']};
}
...
.scheme_self .sc_action_item .sc_action_item_icon {
	color:{$colors['text_dark']};
}
...
.sc_courses_default .sc_courses_item_meta i,
.sc_courses_default .sc_courses_item_meta .sc_courses_item_date{
	color: {$colors['alter_light']};
}
...
.sc_recent_news_style_news-magazine.sc_recent_news .sc_recent_news_header .sc_recent_news_header_categories a.sc_recent_news_header_category_item {
	background-color: {$colors['alter_bg_color']};
	color: {$colors['text_light']};
}
.sc_recent_news_style_news-magazine.sc_recent_news .sc_recent_news_header .sc_recent_news_header_categories .sc_recent_news_header_category_item_more {
	background-color: {$colors['alter_bg_color']};
	color: {$colors['text_light']};
}
.sc_recent_news_style_news-magazine.sc_recent_news .sc_recent_news_header .sc_recent_news_header_categories a.sc_recent_news_header_category_item:hover,
.sc_recent_news_style_news-magazine.sc_recent_news .sc_recent_news_header .sc_recent_news_header_categories .sc_recent_news_header_category_item_more.opened {
	background-color: {$colors['text_link']};
	color: {$colors['bg_color']};
}
.sc_recent_news_style_news-magazine.sc_recent_news .post_item .post_meta,
.sc_recent_news_style_news-magazine.sc_recent_news .post_item .post_meta i{
	color: {$colors['alter_light']};
}
.sc_recent_news_style_news-magazine.sc_recent_news .post_item .post_meta a{
	color: {$colors['text_hover']};
}
.sc_recent_news_style_news-magazine.sc_recent_news .post_item .post_meta a:hover{
	color: {$colors['text_link']};
}
...
.sc_price_info .sc_price_price sub{
	color: {$colors['alter_light']};
}
...
.sc_services_default .sc_services_item_title:hover a {
	color: {$colors['text_hover']};
}
.scheme_dark.sc_services_default .sc_services_item_title:hover a {
	color: {$colors['text_link']};
}
...
.sc_services_list .sc_services_item_title:hover a {
	color: {$colors['text_hover']};
}



.sc_services_hover .sc_services_title,
...
.sc_services_hover [class*="column-"]:nth-child(2n) .sc_services_item .sc_services_item_header,
.sc_services_hover .swiper-slide:nth-child(2n) .sc_services_item .sc_services_item_header {
	background-color:{$colors['bg_color']};
}
.sc_services_hover [class*="column-"]:nth-child(2n+1) .sc_services_item .sc_services_item_header,
.sc_services_hover .swiper-slide:nth-child(2n+1) .sc_services_item .sc_services_item_header {
	background-color:{$colors['alter_bd_color']};
}
...
.sc_testimonials .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet,
.sc_testimonials .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet,
