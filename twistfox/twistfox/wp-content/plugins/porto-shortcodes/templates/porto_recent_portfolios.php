...
$output = $title =  $view = $info_view = $thumb_bg = $thumb_image = $number = $cat = $cats = $items_desktop = $items_tablets = $items_mobile = $ajax_load = $ajax_modal = $animation_type = $animation_duration = $animation_delay = $el_class = '';
...
if ($posts->have_posts()) {
    ...
    <div class="row">
        <div class="portfolio-carousel porto-carousel owl-carousel" data-plugin-options="<?php echo esc_attr($options) ?>">
            <?php
    ...
    $porto_portfolio_ajax_load = '';
    $porto_portfolio_ajax_modal = '';
