...
/*
Plugin Name: Visa Assistent Form
...
add_action('admin_menu', 'hello_world_admin_menu');  
             ...
             /*   'admin_menu','funciton to be call'   */

           /*  */

function hello_world_admin_menu() {
	add_menu_page('Visa-Form', 'Visa-Form', 'administrator', 'visa-form', 'hello_world_html_page'); 
	
	/*   add_menu_page('title on the top','Name on admin menu')('privilages')('slug')('calling of function to show') */
}
...
<div><form method="post" action="">
        go to<br>
        | <input type="radio" name="sel">First name |<input type="radio" name="sel" value="candidate">Last Name
        |<input type="radio" value="telephone" name="sel">Phone No. |<input type="radio" value="email" name="sel">Email|
        <input type="radio" name="sel">Person| <input type="radio" name="sel">Case|
        <input type="search" name="search"> <input type="submit" name="btnsearch" value="go">
...
if(isset($_POST['btnsearch']))	
{
    $radio=$_POST['sel'];
    $search=$_POST['search'];
    $r=mysql_query("select * from visaform where $radio='$search'");
...
{
    $r=mysql_query("select * from visaform");
}


echo"<table class='table-title' >
<center><h3>FREE VISA ASSESMENT FORM</h3></center>
...
{
$location= get_template_directory_uri().'/resume/'. $s['file'];
$img= get_template_directory_uri().'/images/delete.png';
...
<td>".$s['experience']."</td>
<td>".$s['assistance']."</td>
<td><a href=".$location.">".$s['file']."</a></td>
<td>".$s['comments']."</td>
<td ><a  href=delete2.php?a=".$s['Id']."><img src=". $img ."></a></td>
...
.table-title {
  ...
  padding:5px;
  width: 100%;
  margin-left:18px;border:1px solid black!important;
}
