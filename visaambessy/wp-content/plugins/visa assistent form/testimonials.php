...
$show_testimonials = get_post_meta($page_id, 'show_testimonials', true);

if ( $show_testimonials ) {
?>

<div id="testimonials" class="page-element" style="background: transparent url(<?php echo $options['testimonials-background'] ?>) top center no-repeat; background-size: cover;">
    <div class="container">

        <?php if ( isset($options['testimonials-heading']) ) : ?>
        <h3><?php echo $options['testimonials-heading'] ?></h3>
        <?php endif; ?>

        <?php if ( isset($options['testimonials-content']) ) : ?>
        <p><?php echo $options['testimonials-content'] ?></p>
        <?php endif; ?>
                ...
                <?php       
                 ...
                 //   if ( $testimonials->have_posts() ) {
                  //      while ( $testimonials->have_posts()) {
                   ...
                   //         $testimonial_author = explode(' ', $testimonial_author); ?>
                   //          <li data-author="<?php// echo implode('&nbsp', $testimonial_author) ?>"><?php the_content(); ?></li>
                        <?php  //}
                      //  }
                        ?>
            </ul>
