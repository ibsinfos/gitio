...
// echo $a;
//if($a == 918 ){
//    header("location: http://global-migrate.infowiz.in/full-austriala/");
//}
//
//?>
<div class="row">
...
// $p_id =get_p_id();
 ...
 // echo get_the_post_thumbnail($id, 'thumbnail');
  //echo '<div class="banner_image"  style="width: 99.2%; margin-top: -20px; margin-bottom: 28px; margin-left: 16px;">';
...
//  echo '</div>';
  ...
  ?> 
            ...
            <div class="col-md-7 set2" style="width: 674px;">
