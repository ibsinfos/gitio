...
$dbhost='cust-mysql-123-21'; // site
$db='dbnotreal'; // your database username   
$dbuser='dbnotreal'; // your database username   
$dbpass='N2WF6Y!mH'; // your database user's password
$conn = new mysqli($dbhost,$db,$dbpass,$db);
