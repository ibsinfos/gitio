...
<div class="row">
  <div class="container">
        ...
        <div class="sidebar">
          ...
          <div class="frrasse_bg">
            ...
            <div class="drp_dwn_pnl">
              <select class="drpDwnlst" id="living">
            ...
            <lable id="living1"></lable>
          </div>
          <div class="frrasse_bg1">
            <div class="no2"></div>
            <div class="fr_txt"> &nbsp;&nbsp;  Where do you want to go? </div>
            <div class="drp_dwn_pnl">
              <select class="drpDwnlst" id="select" name="going">
                <option selected="selected" label="Select your country of choice" value="">Select your country of choice</option>
                <option label="---------------------------------" value=" ">---------------------------------</option>
                <!--                                <option value="visa">Australia</option>                                <option value="2">Canada</option>                                <option value="57">Denmark</option>                                <option value="223">United Kingdom</option>-->
                <option value="australia_visa">Australia</option>
          ...
          <div class="button-back">
            <button class="btn btn-primary go" name="go" onclick="abc()"> &nbsp;<span style="margin:-22px 0 0 20px;">Go</span> </button>
            <script>                            function abc() {
        var a = document.getElementById("select").value;
        var b = document.getElementById("living").value;
        if (b == '') {
            document.getElementById("living1").innerHTML = "Select any value first";
            document.getElementById('living').focus();
        } else {
            var url = "<?php echo site_url(); ?>/" + a;
            window.location = url;
            return true;
        }
    }</script> 
    ...
    <!--Row of search bar and banner--> <!--div class="row"-->
    <div class="col-md-12">
      <div class="msg-box">
        <p> As one of the most successful immigration consultancies in the world, Emigration-Expert has helped individuals, families, and 
          corporate clients with their visa applications for many years. Our consultants are legally trained and keep up to date on the 
          ever-changing immigration rules for the United Kingdom, Canada, Australia, and Denmark.Emigration-Expert is considered the expert 
          of experts and whether you’re a student or a high net worth investor, we aim to make your immigration dreams come true. We
          provide you with unrivaled service throughout the visa process. This is why most of our customers say they would recommend us. </p>
      </div>
    </div>
    <div class="col-md-12" style="width:100%; float: left; margin-top: -7px;">
      <div class="col-sm-6 col-md-6 set2"> <img alt="Work Visa" src="<?php echo get_template_directory_uri(); ?>/images/panel-work.jpg" class="bg">
        <div>
          <h2> <img src="<?php echo get_template_directory_uri(); ?>/images/austrailia.png"> <span class="country-color"><a href="<?php echo site_url(); ?>/australia_visa/">Australia Visas</a></span> </h2>
          <span class="desc"> Australia Work Permits                        Australia Business Visas                        Australia Immigration </span> <a href="<?php echo site_url(); ?>/australia_visa/"> <img src="<?php echo get_template_directory_uri(); ?>/images/panel-button-action.png" class="action"> </a> </div>
      </div>
      <div class="col-sm-6 col-md-6 set2"> <img alt="Work Visa" src="<?php echo get_template_directory_uri(); ?>/images/panel-travel.jpg" class="bg">
        <div>
          <h2> <img src="<?php echo get_template_directory_uri(); ?>/images/canada.png"> <span class="country-color"> <a href="<?php echo site_url(); ?>/canada-visa/">Canada 
            Visas </a> </span> </h2>
          <span class="desc"> Canada Work Permits   
          Canada Immigration     
          Canada Business Visas </span> <a href="<?php echo site_url(); ?>/canada-visa/"> <img src="<?php echo get_template_directory_uri(); ?>/images/panel-button-action.png" class="action"> </a> </div>
      </div>
    </div>
    <div class="col-md-12" style="width:100%; float: left; margin-top: -10px;">
      <div class="col-sm-6 col-md-6 set2"> <img alt="Work Visa" src="<?php echo get_template_directory_uri(); ?>/images/panel-working-holiday.jpg" class="bg">
        <div>
          <h2> <img src="<?php echo get_template_directory_uri(); ?>/images/denmark.png"> <span class="country-color"><a href="<?php echo site_url(); ?>/denmark/">Denmark Visas</a></span> </h2>
          <span class="desc"> Denmark Work Permits   Move to the Denmark   Denmark Business Visas </span> <a href="<?php echo site_url(); ?>/denmark/"><img src="<?php echo get_template_directory_uri(); ?>/images/panel-button-action.png" class="action"> </a></div>
      </div>
      <div class="col-sm-6 col-md-6 set2"> <img alt="Work Visa" src="<?php echo get_template_directory_uri(); ?>/images/panel-family.jpg" class="bg">
        <div>
          <h2><img src="<?php echo get_template_directory_uri(); ?>/images/uk.png"> <span class="country-color"> <a href="<?php echo site_url(); ?>/uk/"> UK Visas</a> </span> </h2>
          <span class="desc"> UK Work Permits  
          UK Tier Visas  UK Business Visas </span> <a href="<?php echo site_url(); ?>/uk/"> <img src="<?php echo get_template_directory_uri(); ?>/images/panel-button-action.png" class="action"> </a></div>
      </div>
    </div>
    <!--div class="col-md-12" style="border: 1px solid #CCCCCC;border-radius: 10px;margin: 10px 0 0 1.5%;width: 98%;">        <img src="<?php //echo get_template_directory_uri();                   ?>/images/BHF Logo.png" class="logoset"/>    </div--> </div>
</div>
<?php get_footer(); ?>
