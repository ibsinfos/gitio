...
<!--                                <option value="visa">Australia</option>
            ...
            <div class="col-md-7 set2">
                <div class="banner"> <img src="<?php $image = get_field('travel'); echo $image; ?>" id="img1" width="735px" height="243px" /> </div>
                <ul id="billboardmenu">
        ...
        function mouseOverImage() {
            document.getElementById("img1").src = "<?php $image = get_field('work'); echo $image; ?>";
        }
 
        function mouseOverImage1() {
            document.getElementById("img1").src = "<?php $image = get_field('work_holidays'); echo $image; ?>";
        }
        
        function mouseOverImage2() {
            document.getElementById("img1").src = "<?php $image = get_field('family'); echo $image; ?>";
        }
        function mouseOverImage3() {
            document.getElementById("img1").src = "<?php $image = get_field('travel'); echo $image; ?>";
        }
    </script>
        ...
        <div class="col-md-12">
            <div class="msg-box">
                <p>
                    ...
                    of experts and whether you are a student or a high net worth investor, we aim to make your immigration dreams come true. We 
        ...
        <div class="col-md-12" style="width:104%;margin-left: -6px; float: left; margin-top: 10px;">
                <?php
$catquery = new WP_Query( 'cat=10&posts_per_page=9&order=ASC' );
$i=0;
while($catquery->have_posts()) : $catquery->the_post();
$i++;
?>
            <div class="col-sm-4 col-md-4 set2 <?php if($i%3==0){echo "third_position";} ?>" stlye="float:left;"> 
                <div class="bg" style="margin:0 0 0 -5px;"></div>
                 <?php the_post_thumbnail(array(360,168));?>
                    <div>
                        <h2>
                              <!--img src="<?php //echo get_template_directory_uri();  ?>/images/austrailia.png"--> 
                            <span class="country-color"><a href="<?php echo get_permalink($post->ID)?>"><?php the_title(); ?></a></span> </h2>
                        <span class="desc"> <a href="<?php echo get_permalink($post->ID); ?>" > 
						<span style="color:gray"><?php echo substr(strip_tags($post->post_content), 0, 90);?>.</span></a>
                           <?php //the_content(); ?>
                        </span> 
                        <a href="<?php echo get_permalink($post->ID)?>" ><img src="<?php echo get_template_directory_uri(); ?>/images/panel-button-action.png" class="action"> </a>
                    </div>
            </div> 
