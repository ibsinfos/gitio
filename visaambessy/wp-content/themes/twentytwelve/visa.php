...
/*
 * Template Name: Australia Visa Page
 */
...
<!--                                <option value="visa">Australia</option>
        ...
        function mouseOverImage1() {
            document.getElementById("img1").src = "<?php $image = get_field('working_holidays'); echo $image; ?>";
        }
        
        function mouseOverImage2() {
            document.getElementById("img1").src = "<?php $image = get_field('banner_family'); echo $image; ?>";
        }
        ...
        <div class="col-md-12" style="width:104%;margin-left: -6px; float: left; margin-top: 10px;">
                <?php
$catquery = new WP_Query( 'cat=8&posts_per_page=9&order=ASC' );
$i=0;
