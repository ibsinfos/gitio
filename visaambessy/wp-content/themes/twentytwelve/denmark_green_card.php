...
/*
 * Template Name: full denamrk green card page
 */
...
echo get_the_post_thumbnail($id,  array(735,279));
  echo '</div>';
  echo '<div class="cat_title_banner"><marquee>';
...
$catquery = new WP_Query( 'cat=38&posts_per_page=10&order=ASC' );
$i=0;
...
?>
            <div class="col-sm-4 col-md-4 ravi <?php if($i%3==0){echo "third_position_ravi";} ?>" stlye="float:left;"> 
                <div class="ravi_iner" style="margin:0 0 0 -5px;">
                        ...
                        <span class="con_ravi"> <?php echo substr(strip_tags($post->post_content), 0, 100);?><br> <a href="<?php echo get_permalink($post->ID)?>" >..Read More</a>
                           <?php //the_content(); ?>
                        </span> 
                         <div class="buttion"> <a href="<?php echo site_url(); ?>/free-visa/"> Start Your Free Visa Assessment</a></div>
