...
<!--                                <option value="visa">Australia</option>
        ...
        <div class="col-md-12" style="width:104%;margin-left: -6px; float: left; margin-top: 10px;">
                <?php
$catquery = new WP_Query( 'cat=11&posts_per_page=9&order=ASC' );
$i=0;
                 ...
                 <?php the_post_thumbnail(array(360,168));?>
                    <div>
                        <h2>
                            ...
                            <span class="country-color"><?php the_title(); ?></span> </h2>
                        <span class="desc"><a href="<?php echo get_permalink($post->ID); ?>" > <?php echo substr(strip_tags($post->post_content), 0, 90);?> </a>
                           <?php //the_content(); ?>
                        </span> 
