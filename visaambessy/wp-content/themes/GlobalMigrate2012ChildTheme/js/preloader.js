...
var cond = document.getElementById("lastname").value;
    ...
    if (cond == '')
    {
      ...
      document.getElementById('lastname2').innerHTML = "Please Enter Your Name";
    ...
    else if (!isNaN(cond))
    {
      ...
      document.getElementById('lastname2').innerHTML = "Please enter a valid name";
    ...
    {
      document.getElementById("lastname2").innerHTML = "";
    }
