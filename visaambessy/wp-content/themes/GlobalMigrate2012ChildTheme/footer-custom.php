        ...
        <div class="col-md-12 typevisa">
            ...
            <div class="col-md-3">
                <div class="workvisa2">
                    <h4>Work Visa</h4>
                    <ul>
                        <li><a href="">Tier 5 - Youth Mobility Scheme</a></li>
                        <li><a href="">Tier 1 - General Extension</a></li>
                        <li><a href="">Overseas Domestic Worker</a></li>
                        <li><a href="">Tier 5 - Temporary Worker Visa</a></li>
                        <li><a href="">Tier 2 - General Visa</a></li>
                        <li><a href="">Tier 1 - Post-Study Work Extension</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
                <div class="workvisa2">
                    <h4>Travel Visa</h4>
                    <ul>
                        <li><a title="" href="">Tier 1 - Investor Visa</a></li>
                        <li><a title="" href="">Tier 1 - Entrepreneur Visa</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
                <div class="workvisa2">
                    <h4>Family Visas</h4>
                    <ul>
                        <li><a title="" href="">EEA Family Visa</a></li>
                        <li><a title="" href="">Partner Visa</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
                <div class="workvisa2" style="border-right:none;">
                    ...
                    <ul>
                        <li><a href="">Tier 4 - Student (Adult) Visa</a></li>
                        <li><a href="">Tier 4 - Student (Child) Visa</a></li> 
                    </ul>
                </div>
            </div>
