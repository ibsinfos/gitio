...
/*
 * Template Name: full canada maariage page
 */
                    ...
                    <div class="button-back">
                        ...
                        <script>
...

                            {
                                ...
                                var url = "http://global-migrate.infowiz.in/" + a;
...
echo get_the_post_thumbnail($id,  array(735,279));
  echo '</div>';
   echo '<div class="cat_title_banner">';
   echo $cat_name = get_the_title( $id ) ;
echo '</div>';
  ?>
<!--                <div class="banner"> <img src="/wp-content/uploads/2014/06/bner.png" id="img1" width="735px" height="243px" /> </div>
                <ul id="billboardmenu">
                    <li class="travel   default first"> <a href="/visitor_visa/" class="current" onmouseover="mouseOverImage3()" >TRAVEL   </a>	</li>
                    <li class="work"> <a href="/work_visa/" class="" onmouseover="mouseOverImage()"> WORK </a>	</li>
                    <li class="working holiday"> <a href="/work_visa/tier_5_youth_mobility_scheme_working_holiday_visa/" class="" onmouseover="mouseOverImage1()"> WORKING HOLIDAY </a>	</li>
                    <li class="family"> <a href="/family_visa/" class="" onmouseover="mouseOverImage2()"> FAMILY </a>	</li>
                </ul>-->
            </div>
        </div>
<!--        <script language="javascript" type="text/javascript">
        function mouseOverImage() {
            document.getElementById("img1").src = "/wp-content/uploads/2014/07/bs.png";
        }
 
        function mouseOverImage1() {
            document.getElementById("img1").src = "/wp-content/uploads/2014/07/pr.png";
        }
        
        function mouseOverImage2() {
            document.getElementById("img1").src = "/wp-content/uploads/2014/07/f1.png";
        }
        function mouseOverImage3() {
            document.getElementById("img1").src = "/wp-content/uploads/2014/06/bner.png";
        }
        ...
        <div class="col-md-12" style="width:104%;margin-left: -6px; float: left; margin-top: 26px;">
...
$catquery = new WP_Query( 'cat=27&posts_per_page=10&order=ASC' );
$i=0;
while($catquery->have_posts()) : $catquery->the_post();
$i++;
?>
            <div class="col-sm-4 col-md-4 ravi <?php if($i%3==0){echo "third_position_ravi";} ?>" stlye="float:left;"> 
                <div class="ravi_iner" style="margin:0 0 0 -5px;">
                  
                    
                        <h2>
                              <!--img src="<?php //echo get_template_directory_uri();  ?>/images/austrailia.png"--> 
                            <span class="ravi-color"><?php the_title(); ?></span> </h2>
                        <span class="con_ravi"><?php echo substr(strip_tags($post->post_content), 0, 100);?> <a href="<?php echo get_permalink($post->ID); ?>" >..Read More</a> 
                           <?php //the_content(); ?>
                        </span> 
                        <div class="buttion"> <a href="http://localhost/global-migrate/free-visa/"> Start Your Free Visa Assessment</a></div> 
