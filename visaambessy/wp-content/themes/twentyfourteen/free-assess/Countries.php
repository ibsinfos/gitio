...
<select name="residingcountry" id="residingcountry"> 
   ...
   <?
      ...
      while(!$all_countries->EOF)
	  {
		echo "<option value=\"".$all_countries->fields['id']."\">".$all_countries->fields['country_name']."</option>";  
		$all_countries->movenext();
		}
	  ?>
</select></dd> 

<dt id="destinationcountry-label"><label for="countrydetails-destinationcountry" class="required">Where do you want to go?</label></dt> 

<dd id="destinationcountry-element"> 
...
<select name="destinationcountry" id="destinationcountry"> 
    ...
    <option value=" " label="---------------------------------">---------------------------------</option> 
	    ...
	    <?
	  $all_des_countries= all_countries(); //des_county();
      while(!$all_des_countries->EOF)
	  {
		echo "<option value=\"".$all_des_countries->fields['id']."\">".$all_des_countries->fields['country_name']."</option>";  
		$all_des_countries->movenext();
		}
	  ?>
</select></dd> 
...
<input type="submit" name="countrydetails[save]" id="countrydetails-save" value="Submit and Continue" style="width:200px; height:32px; background:#335191; border:none; color:#FFF;  margin-right:6px; margin-top:3px; cursor:pointer;" /></dd></dl></form>
