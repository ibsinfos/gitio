...
echo $tt;
if($_REQUEST['step']==6){
include_once("scripts/message_body_admin.php");
}
...
<link href="style/ea-visas.css" rel="stylesheet" type="text/css" />
	<div class="txt-normal_medium">
	  <p class="style1">You have successfully completed the FREE assessment. </p>
	  <p class="style1">Now one of highly qualified Immigration advisors will be in touch with you very shortly.</p>
	  <p class="style1">However, if you would like to know the result of this assessment ASAP please do not hesitate to contact us directly on 02079934762.</p>
	  <p><span class="style1">In the mean time the Global Migrate team would like to wish you the very best of luck with your visa application and we look forward to working with you all the way towards achieving your dreams.</span> <br />
      </p>
	  <br />
</div>
<table width="260" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="218">
          ...
          <input type="hidden" name="step" value="<? echo $_REQUEST['step'];?>"></td>
      </tr>
      <tr>
        <td height="30">&nbsp;</td>
        <td>&nbsp;</td>
...
/* <![CDATA[ */
var google_conversion_id = 1027261930;
var google_conversion_language = "en";
var google_conversion_format = "2";
var google_conversion_color = "ffffff";
var google_conversion_label = "Z13uCKbhqwIQ6ovr6QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1027261930/?label=Z13uCKbhqwIQ6ovr6QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
