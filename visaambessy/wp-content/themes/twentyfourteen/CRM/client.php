...
if($_REQUEST['casestatus']!="")
	{
		$sql="Update cases set casestatusid='$_REQUEST[casestatus]' where clientid='$_REQUEST[client]' and caseid='$_REQUEST[shortbycaseid]'";	
		
		$conn->execute($sql);
		
			$event_sql="insert into all_events set caseid='$_REQUEST[shortbycaseid]', schedulefor='', scheduleset_by='$_SESSION[employeeid]', eventfor_client='$_REQUEST[client]', eventtype='Single Event', taskdate='', urgent='', events='$_REQUEST[casestatus]', eventdetails='$_REQUEST[add_info]', eventstatus='Completed'";
			
	$conn->execute($event_sql);	

	}
$clientinfo=client_details($_REQUEST[client]);
?>
<table width="100%" border="0" bgcolor="#CCCCCC">
  <tr>
    <td valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="2">
      <tr>
        <td width="6%" align="right" class="menutext"><strong>Individul :</strong></td>
        <td colspan="2" bgcolor="#FFFFFF" class="menutextH" align="center"><? echo $clientinfo->fields['title']." ".$clientinfo->fields['firstname']." ".$clientinfo->fields['lastname']; ?></td>
        <td width="22%" align="center" class="menutextH">Private Individuale</td>
        <td width="18%">&nbsp;</td>
        <td width="18%">&nbsp;</td>
        <td width="21%">&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td width="12%" bgcolor="#FFFFFF" class="menutextH" align="center"><? echo $_REQUEST[client]; ?></td>
        <td width="3%">&nbsp;</td>
        <td align="center" class="menutextH">no Associated Company</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td align="center"><input type="submit" name="button" id="button" value="Add this person to Company"></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="7">
  <ul id="globalnav">
  <li><a href="index.php?client=<? echo $_REQUEST[client];?>&subpage=1&page=2"><? if($_REQUEST['subpage']=="1"){ ?><font size="2">People</font> <? } else { ?> People <? } ?></a></li>
  <li><a href="index.php?client=<? echo $_REQUEST[client];?>&subpage=2&page=2"><? if($_REQUEST['subpage']=="2"){ ?><font size="2">Cases</font> <? } else { ?>Cases <? } ?></a></li>
  <li><a href="index.php?client=<? echo $_REQUEST[client];?>&subpage=3&page=2"><? if($_REQUEST['subpage']=="3"){ ?><font size="2">Event</font> <? } else { ?>Event <? } ?></a></li>
  <!--
  <li><a href="index.php?client=</ul>? echo $_REQUEST[client];?/>&subpage=4&page=2"></ul>? if($_REQUEST[subpage]==4){ ?/><font size="2">Account</font> </ul>? } else { ?>Account </ul>? } ?/></a></li>
  -->
  <li><a href="index.php?client=<? echo $_REQUEST[client];?>&subpage=5&page=2"><? if($_REQUEST['subpage']=="5"){ ?><font size="2">Documents</font> <? } else { ?>Documents <? } ?></a></li>
  <li><a href="index.php?client=<? echo $_REQUEST[client];?>&subpage=6&page=2"><? if($_REQUEST['subpage']=="6"){ ?><font size="2">Login Area</font> <? } else { ?>Login Area <? } ?></a></li>
  <li><a href="index.php?client=<? echo $_REQUEST[client];?>&subpage=7&page=2"><? if($_REQUEST['subpage']=="7"){ ?><font size="2">Product Info</font> <? } else { ?>Product Info <? } ?></a></li>
</ul>
</td>
        </tr>
      <tr>
...
{
case 1: include_once("includes/client_details.php");  break;
case 2: include_once("includes/client_case.php");  break;
case 3: include_once("includes/events.php");  break;
case 4: include_once("includes/account.php");  break;
case 5: include_once("includes/document.php");  break;
default: include_once("includes/client_details.php");  break;
}
