...
<script type="text/javascript">
 ...
 <table width="400" border="0" cellspacing="2" cellpadding="2">
      <tr class="menutextH"  bgcolor="#999999">
        <td width="100">Date / Time</td>
        <td width="100">Details</td>
		<td width="100">Case ID</td>
 ...
 <?
 $client_events=history($_SESSION['employeeid']);
 $i=0;
 while(!$client_events->EOF)
 {
  ...
  ?>
        ...
        <td width="100"><a href="#" onclick="window.opener.document.location.href='index.php?client=<? echo $client_events->fields['eventfor_client']; ?>&page=2'; window.parent.close(); return false;"><? echo $client_events->fields['eventsetdate'];?></a></td>
        <td width="100"><a href="#" onclick="window.opener.document.location.href='index.php?client=<? echo $client_events->fields['eventfor_client']; ?>&page=2'; window.parent.close(); return false;"><? echo get_value_by_id('event_cat_name', 'events_catagories', 'event_cat_id',$client_events->fields['events']); ?></a></td>
		<td width="100"><a href="#" onclick="window.opener.document.location.href='index.php?client=<? echo $client_events->fields['eventfor_client']; ?>&page=2'; window.parent.close(); return false;"><? echo $client_events->fields['caseid'];?></a></td>
		<td width="100"><a href="#" onclick="window.opener.document.location.href='index.php?client=<? echo $client_events->fields['eventfor_client']; ?>&page=2'; window.parent.close(); return false;"><? echo $client_events->fields['eventfor_client'];?></a></td>
		<td width="100"><a href="#" onclick="window.opener.document.location.href='index.php?client=<? echo $client_events->fields['eventfor_client']; ?>&page=2'; window.parent.close(); return false;"><? echo get_value_by_id('firstname', 'Enquiries', 'id',$client_events->fields['eventfor_client'])." ".get_value_by_id('lastname', 'Enquiries', 'id',$client_events->fields['eventfor_client']); ?></a></td>
         </tr>
 <?
 $i++;
$client_events->MoveNext(); 
 }
 ?> 
