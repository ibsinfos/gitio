...
if($_SESSION['login']=="yes"){header("location: index.php?page=1");}

if($_REQUEST[submit]!="")
{
	$myusername=$_REQUEST['uname']; 
	$mypassword=$_REQUEST['upass'];
	
	$sql=$conn->Execute("SELECT *, Count(employeeid) FROM employee WHERE username='$myusername' and userpass='$mypassword'");
	//echo $sql->fields['Count(employeeid)'];
	if($sql->fields['Count(employeeid)']==1)
	{
		
		
	$_SESSION['login']="yes";
	$_SESSION['employeeid']=$sql->fields['employeeid'];
	$_SESSION['name']=$sql->fields['name'];
	$_SESSION['access_right']=$sql->fields['access_right'];
	$_SESSION['employeeemail']=$sql->fields['email'];
  ...
  <tr>
    ...
    <table width="50%" border="0">
      ...
      <tr>
        ...
        <td width="85%"><label for="uname"></label>
          <input type="text" name="uname" id="uname" autocomplete="off"></td>
      </tr>
      <tr>
        <td>Password : </td>
        <td><input type="password" name="upass" id="upass" autocomplete="off"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
