...
include(TEMPLATEPATH ."Config/Config.php");
include_once(TEMPLATEPATH ."CRM/fun/fun.php");
include_once(TEMPLATEPATH ."CRM/fun/sqlfun.php");
include_once(TEMPLATEPATH ."CRM/fun/emailfun.php");

?>
<?php
/**
 * Template Name: Free Assessment
 *
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" width="988">
    <tbody>
      ...
      <tr>
        ...
        <h1>UK Immigration | Canada Immigration</h1>
            <table border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  <td width="1473" colspan="2"><h3 style="font-size:14px; font-style:italic; font-weight:normal;">Let's start your FREE assessment here. Please note that the FREE assessment will only entitle you to check your eligibility criteria. There will normally be a fee to help you lodge your visa application</h3></td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="normalTxt"><p>  <form name="assesment" id="assesment" action="free-assessment-new.php" method="get">
			      </form>
				   <form name="assesment" id="assesment2" action="free-assessment-new.php" method="get">
				     <? include_once("free-assess/Countries.php");?>
			        </form> </p> </td>
                </tr>
                <tr>
                  <td align="left">  </td>
