...
<head>
    ...
    <meta name="alexaVerifyID" content="izg-vv6kVvOHGPw_i8fClpjvYgU" />
<meta name="author" content="www.global-migrate.com" />  
  <meta name="email" content="info@global-migrate.in" /> 
     <meta name="Distribution" content="Global" />   
      <meta name="Rating" content="General" />   
       <meta name="robots" content="index,follow" />  
         <meta name="Revisit-after" content="3 Days" />    
         <meta name="city" content="Piccadilly" />
...
<link type="text/css" href="<?php bloginfo ('template_url'); ?>/style.css" rel="stylesheet" />	
		        ...
		        <script type="text/javascript" async src="<?php bloginfo ('template_url'); ?>/js/ga.js">
        </script>
		<script type="text/javascript" async src="<?php bloginfo ('template_url'); ?>/js/plusone.js" gapi_processed="true"></script>
		...
		<script type="text/javascript" src="<?php bloginfo ('template_url'); ?>/js/ddaccordion.js"></script>
...
<link rel="stylesheet" href="<?php bloginfo ('template_url'); ?>/css/style1.css" type="text/css" media="screen" />
        <link href="<?php bloginfo ('template_url'); ?>/css/global.css" rel="stylesheet" type="text/css" />
			<script type="text/javascript" src="<?php bloginfo ('template_url'); ?>/js/jquery.js"></script>
            <script type="text/javascript" src="<?php bloginfo ('template_url'); ?>/js/scripts.js"></script>
            <script src="<?php bloginfo ('template_url'); ?>/js/jquery-1.2.1.min.js" type="text/javascript"></script>
...
<div id="header">
<div id="logo-cntnr"><a rel="nofollow" href="index.php"><img src="<?php bloginfo ('template_url'); ?>/images/immigration-logo.jpg"  border="0" /></a></div>
...
<script type="text/javascript">
 (function() {
   ...
   var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
    ...
    <td align="right"><img src="<?php bloginfo ('template_url'); ?>/images/logos-acc.gif" alt="Accreditations" width="328" height="60" border="0" style="float: right;" /></td>
  </tr>
</table>
</div>
<div id="over-800"><img src="<?php bloginfo ('template_url'); ?>/images/Because-our-clients.png" width="280" height="29" alt="Clients" /></div>
<div class="top"><img src="<?php bloginfo ('template_url'); ?>/images/top-logo.jpg" /></div>
</div>
<div id="menu">
<div id="nav_menu">
...
<!--<a rel="nofollow" href="?page_id=4" class="nav_menu">About Us </a> | 
...
<table width="976" height="260" border="0" align="center" cellpadding="0" cellspacing="0" style="background:url(<?php bloginfo ('template_url'); ?>/images/bnnr_bg.jpg); background-repeat:repeat-x; height:260px;">
  <tbody><tr>
    <td height="12"></td>
    ...
    <div id="slider-wrapper" >
     <div id="slider" class="nivoSlider" > 
        ...
        <img src="<?php bloginfo ('template_url'); ?>/images/banner1.jpg" alt="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK" Title="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK" />   
        
        
        <img src="<?php bloginfo ('template_url'); ?>/images/banner2.jpg" alt="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK" Title="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK" /> 
		 
     
     
         <img src="<?php bloginfo ('template_url'); ?>/images/banner3.jpg" alt="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK" Title="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK"  /> 
		 
         
          <img src="<?php bloginfo ('template_url'); ?>/images/banner4.jpg" alt="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK" Title="Denmark Migration | Canada Immigration | Australian Work Visa | UK Ancestry Visas | Marriage UK" /> 
              </div>
            ...
            <div class="frrasse_bg1">
              ...
              <div class="drp_dwn_pnl">
                <select  class="drpDwnlst">
                  ...
                  <option value="15">Australia</option><option value="2">Canada</option><option value="57">Denmark</option><option value="223">United Kingdom</option>              </select>
              </div>
            </div>
            <div class="start_btn">
