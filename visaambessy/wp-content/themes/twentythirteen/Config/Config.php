...
$temp=get_domain(curPageURL1());
//echo($temp);

if($temp=="globalmigrate.co.uk")
{
	 include ($_SERVER["DOCUMENT_ROOT"].'/adodb/adodb.inc.php');	
}
else if($temp=="global-migrate.com")
{
	 include ($_SERVER["DOCUMENT_ROOT"].'/adodb/adodb.inc.php');
}
else
{
	 include ($_SERVER["DOCUMENT_ROOT"].'/global-migrate.com/adodb/adodb.inc.php');
}
...
$dbhost='cust-mysql-123-16'; // site

//$Servers//'][$i]['auth_type']='config'; // Authentication method - config, http or cookie

$db='global123'; // your database username   

$dbuser='global123'; // your database username   

$dbpass='Onick!234'; // your database user's password

$conn = ADONewConnection('mysql'); 
if(!$conn->PConnect($dbhost,$dbuser,$dbpass,$db)) { echo "Database Connection Error"; };
