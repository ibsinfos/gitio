...
if(isset($_REQUEST['Next']) && $_REQUEST['occupation']=="")
	{	echo '<div class="ErrorTip">Please select an occupation</div>'; $err=3; }

?>

<dt id="visatype-label"><label for="personaldetails-visatype" >How long have you been working in this field for *<span id="tooltip2"><img id="personaldetails-visatype-tooltipper" src="images/tooltipicon.png" title="" />
  <select name="occupation_duration" id="personaldetails-visatype" style="margin-left:40px;"> 

     <option value="" label="Please select number of years" selected="selected">Please select number of years</option> 
    <option value=" " label="---------------------------------">---------------------------------</option> 
    <option value="0" label="Less than 1 Year">Less than 1 Year</option> 
    ...
    <option value="11" label="11 Years">11 Years</option> 
    <option value="12" label="12 Years">12 Years</option> 
    <option value="13" label="13 Years">13 Years</option> 
    <option value="14" label="14 Years">14 Years</option> 
    <option value="15" label="15 Years">15 Years</option> 
    <option value="16" label="16 Years">16 Years</option> 
    <option value="17" label="17 Years">17 Years</option> 
    <option value="18" label="18 Years">18 Years</option> 
    <option value="19" label="19 Years">19 Years</option> 
    <option value="20" label="20 Years">20 Years</option> 
</select></dd> 
<?PHP
if(isset($_REQUEST['Next']) && $_REQUEST['occupation_duration']=="")
	{	echo '<div class="ErrorTip">Please select number of years</div>'; $err=3;}

?> 
<dt><label for="personaldetails-title" >What is your highest qualification *</label></dt> 
...
<?PHP
 if(isset($_REQUEST['Next']) && $_REQUEST['education']=="")
	{	echo '<div class="ErrorTip">Please select a qualification</div>'; $err=3;}
/*   if (Security::bdd($_GET['save']=="Submit") AND Security::bdd($_GET['title']=="")){
  echo '<div class="ErrorTip">Please select your title</div>';
}*/
?> 

<dt id="firstname-label"><label for="personaldetails-firstname" >Was the course taught in english  *</div>
</label></dt>
<dd> 

<select name="ed_medium"> 
...
<?PHP
 if(isset($_REQUEST['Next']) && $_REQUEST['ed_medium']=="")
	{	echo '<div class="ErrorTip">Please make a selection</div>'; $err=3; }
...
<table width="260" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="218">
<input type="hidden" name="lc" value="<? echo $_REQUEST['lc'];?>">
<input type="hidden" name="residingcountry" value="<? echo $_REQUEST['residingcountry'];?>">
<input type="hidden" name="destinationcountry" value="<? echo $_REQUEST['destinationcountry'];?>">
<input type="hidden" name="step" value="<? echo $_REQUEST['step'];?>">

<input type="submit" name="Next" id="personaldetails-save" value="Save and Continue" style="width:200px; height:32px; background:#335191; border:none; color:#FFF;  margin-right:6px; margin-top:3px; cursor:pointer;" /></td>
  </tr>
  <tr>
    <td height="30">&nbsp;</td>
    <td>&nbsp;</td>
...
if($err!=3 && $_REQUEST['Next']!="")
{
$sql="UPDATE Enquiries set occupation='$_REQUEST[occupation]', occupation_duration='$_REQUEST[occupation_duration]', education='$_REQUEST[education]', ed_medium='$_REQUEST[ed_medium]' where id='$_REQUEST[lc]'";

if($conn->execute($sql)) { echo "<META HTTP-EQUIV=Refresh CONTENT=\"0; URL=http://www.eavisas.com/free-assessment.php?lc=".$_REQUEST['lc']."&residingcountry=".$_REQUEST['residingcountry']."&destinationcountry=".$_REQUEST['destinationcountry']."&step=4\">";}
