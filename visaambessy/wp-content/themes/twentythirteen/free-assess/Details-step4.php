...
<?PHP
if(isset($_REQUEST['Next']) && $_REQUEST['earn_last12']=="")
	{	echo '<div class="ErrorTip">Please select an amount</div>'; $err=4;}
...
if($err!=4 && $_REQUEST['Next']!="")
{
$sql="UPDATE Enquiries set funds='$_REQUEST[funds]', earn_last12='$_REQUEST[earn_last12]' where id='$_REQUEST[lc]'";

if($conn->execute($sql)) { echo "<META HTTP-EQUIV=Refresh CONTENT=\"0; URL=http://www.eavisas.com/free-assessment.php?lc=".$_REQUEST['lc']."&residingcountry=".$_REQUEST['residingcountry']."&destinationcountry=".$_REQUEST['destinationcountry']."&step=5\">";}
