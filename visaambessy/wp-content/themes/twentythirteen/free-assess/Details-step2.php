...
if(isset($_REQUEST['Next']) && $_REQUEST['e_offer']=="")
	{	echo '<div class="ErrorTip">Please select Yes or No</div>'; $err=2; }

?>

<dt id="visatype-label"><label for="personaldetails-visatype" >Are you married or in a relationship *<span id="tooltip2"><img id="personaldetails-visatype-tooltipper" src="images/tooltipicon.png" title="" />
  <select name="m_status" id="personaldetails-visatype" style="margin-left:40px;"> 
...
<?PHP
if(isset($_REQUEST['Next']) && $_REQUEST['m_status']=="")
	{	echo '<div class="ErrorTip">Please select Yes or No</div>'; $err=2;}

?> 
<dt><label for="personaldetails-title" >How many dependants do you have *</label></dt> 

<dd> 

<select name="dependants"> 

      <option value="" label="Please select number of dependents" selected="selected">Please select number of dependents</option> 
    <option value=" " label="---------------------------------">---------------------------------</option> 
...
<?PHP
 if(isset($_REQUEST['Next']) && $_REQUEST['dependants']=="")
	{	echo '<div class="ErrorTip">Please select number of dependents</div>'; $err=2;}
/*   if (Security::bdd($_GET['save']=="Submit") AND Security::bdd($_GET['title']=="")){
  echo '<div class="ErrorTip">Please select your title</div>';
}*/
?> 

<dt id="firstname-label"><label for="personaldetails-firstname" >How soon do you require your visa  *</div>
</label></dt>
<dd> 

<select name="require_time" id="require_time"> 
...
<?PHP
 if(isset($_REQUEST['Next']) && $_REQUEST['require_time']=="")
	{	echo '<div class="ErrorTip">Please make a selection</div>'; $err=2; }
...
if($err!=2 && $_REQUEST['Next']!="")
{
$sql="UPDATE Enquiries set e_offer='$_REQUEST[e_offer]', m_status='$_REQUEST[m_status]', dependants='$_REQUEST[dependants]', require_time='$_REQUEST[require_time]' where id='$_REQUEST[lc]'";

if($conn->execute($sql)) { echo "<META HTTP-EQUIV=Refresh CONTENT=\"0; URL=http://www.eavisas.com/free-assessment.php?lc=".$_REQUEST['lc']."&residingcountry=".$_REQUEST['residingcountry']."&destinationcountry=".$_REQUEST['destinationcountry']."&step=3\">";}
