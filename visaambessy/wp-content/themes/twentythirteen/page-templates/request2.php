...
$Comment=$_REQUEST['txt_message'];



$dt=date("Y-m-d");

$headers = "From: info@global-migrate.com\r\n";
$headers .= 'Bcc: pradeep_kot@yahoo.com' ;
$f_email = "headoffice@global-migrate.com";
$body_message =" Name : $Name \n\n Email : $Email \n\n  Phone : $Phone  \n\n Comment : $Comment  Date:$dt";
$subject="Mail from Web Site (global-migrate.com) : Request By $Name for Some Query";
mail($f_email,$subject,$body_message,$headers);
$subject="Mail from Web Site (www.global-migrate.com)";
$body_message =" Hi $Name \n\n Thanks for Contacting us\n\n Our Representative will Contact You Shortly \n\n  Regards \n\n Global Migrate Team";
$f_email = $Email;
mail($f_email,$subject,$body_message,$headers);
...
<h2 style="font-size:16px"> Thank you we have received your query and will be in touch with you shortly.</h2>
        </div></td>
