...
include_once("fun/sqlfun.php");
include_once("fun/fun.php");
error_reporting (E_ALL ^ E_NOTICE);
/*
if($_REQUEST['searchitem']=="case"){header("location: index.php?client=$_REQUEST[serkey]&subpage=2&page=2");}
else if($_REQUEST['searchitem']=="person"){header("location: index.php?client=$_REQUEST[person]&subpage=1&page=2");}
*/
...
<link rel="stylesheet" type="text/css" href="style/tabmanu.css">

<link rel="stylesheet" title="Style CSS" href="JsCalender/calendar.css" type="text/css" media="all" />

<script language="javascript" src="js/script.js"></script>
<script type="text/javascript" src="js/drag-drop.js"></script>
<script language="javascript" type="text/javascript" src="JsCalender/datetimepicker.js"></script>
<script type="text/javascript">
	Drag.init(document.getElementById("nameFieldPopup"));
...
<table width="600" border="1" cellspacing="2" cellpadding="2" bordercolor="#FFFFFF">
  <tr>
    <td><? include_once("includes/topmenu.php");?></td>
  </tr>
</table>
<br>
<table width="600" border="0" cellspacing="2" cellpadding="2" align="left">
<tr>
    <td><fieldset><legend>Search</legend><form method="post" action="search.php" name="goto">
 	  <table width="674" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="19%" class="menutextH">Go To</td>
          <td width="25%">&nbsp;</td>
          <td width="15%">&nbsp;</td>
          <td width="11%">&nbsp;</td>
          <td width="13%">&nbsp;</td>
        ...
        <tr>
          <td>
            <input name="searchitem" type="radio" class="textgray" value="firstname" <? if($_REQUEST['searchitem']=="firstname") { ?>checked="checked" <? } ?>>
            <span class="menutextH">            First Name</span></td>
          <td><input name="searchitem" type="radio" value="lastname" <? if($_REQUEST['searchitem']=="lastname") { ?>checked="checked" <? } ?>>
            <span class="menutextH">Last Name</span></td>
          <td><input name="searchitem" type="radio" value="email" <? if($_REQUEST['searchitem']=="email") { ?>checked="checked" <? } ?>>
            <span class="menutextH">Email</span></td>
          <td><input name="searchitem" type="radio" value="case"  <? if($_REQUEST['searchitem']=="case") { ?>checked="checked" <? } ?>>
            <span class="menutextH">Case </span></td>
          <td><input name="searchitem" type="radio" value="id"  <? if($_REQUEST['searchitem']=="id") { ?>checked="checked" <? } ?>>
            <span class="menutextH">Person</span></td>
          <td><input name="searchitem" type="radio" value="contactnumber" <? if($_REQUEST['searchitem']=="contactnumber") { ?>checked="checked" <? } ?>>
            <span class="menutextH">Phone No</span></td>
        </tr>
        <tr>
          <td colspan="2"><input name="serkey" type="text" class="menutext" size="30" id="serkey" value="<? echo $_REQUEST['serkey'];?>" /></td>
          <td><input type="submit" name="go" value="   GO   " class="menutext" id="go" /></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
 ...
 if($_REQUEST['go']!="")
{
 ?> 
  ...
  <tr>
    <td width="6%" class="menutextH">ID</td>
    <td width="18%" class="menutextH">First Name</td>
    <td width="15%" class="menutextH">Last Name</td>
    <td width="19%" class="menutextH">DOB</td>
    <td width="20%" class="menutextH">Email</td>
    <td width="22%" class="menutextH">Contact No</td>
  </tr>
 <?
$searchresult=search($_REQUEST['searchitem'],$_REQUEST['serkey']); 
while(!$searchresult->EOF)
{
 ?>
  <tr bgcolor="#FFFFFF" class="text">
    <td><a href="index.php?client=<? echo $searchresult->fields['id'];?>&page=2" class="tasksfield"><? echo $searchresult->fields['id']; ?></a></td>
    <td><a href="index.php?client=<? echo $searchresult->fields['id'];?>&page=2" class="tasksfield"><? echo $searchresult->fields['firstname']; ?></a></td>
    <td><a href="index.php?client=<? echo $searchresult->fields['id'];?>&page=2" class="tasksfield"><? echo $searchresult->fields['lastname']; ?></a></td>
    <td><a href="index.php?client=<? echo $searchresult->fields['id'];?>&page=2" class="tasksfield"><? echo $searchresult->fields['dob_day']."-".$searchresult->fields['dob_month']."-".$searchresult->fields['dob_year']; ?></a></td>
    <td><a href="index.php?client=<? echo $searchresult->fields['id'];?>&page=2" class="tasksfield"><? echo $searchresult->fields['email']; ?></a></td>
    <td><a href="index.php?client=<? echo $searchresult->fields['id'];?>&page=2" class="tasksfield"><? echo $searchresult->fields['contactnumber']; ?></a></td>
  </tr>
 <?
