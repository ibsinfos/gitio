(function(a) {
    ...
    a.extend(a.layoutDevice, {
        ...
        onReady: function(b, c) {
            ...
            if (b) {
                ...
                for (var d in a.layoutDevice.components)
                    if (a.layoutDevice.components[d]) a.layoutDevice.components[d].onReadyEditorMode();
        ...
        onAjaxLinkClick: function(b, c) {
            for (var d in a.layoutDevice.components)
                if (a.layoutDevice.components[d] && a.layoutDevice.components[d].onAjaxLinkClick) a.layoutDevice.components[d].onAjaxLinkClick(b,
                    c)
        },
        addParallaxBehavior: function() {
            ...
            0 < b.length && c && (b = b.data(), b = b.backgroundParallaxSelector + ",.dmSectionParallaxNew", a(b).filter(":not(.dmSectionNoParallax)").makeParallax(.1));
            if (navigator.userAgent.match(/Trident\/7\./)) a("body").on("mousewheel", function() {
                event.preventDefault();
                window.scrollTo(0, window.pageYOffset - event.wheelDelta)
            })
        },
        setParallax: function(a,
            c) {
