...
// $db='tester'; // your database username   
// $dbuser='tester'; // your database username   
// $dbpass='aW8oa61^'; // your database user's password
// $dbhost='glo1619909091678.db.9899235.hostedresource.com'; // site
// $db='glo1619909091678'; // your database username   
// $dbuser='glo1619909091678'; // your database username   
// $dbpass='r0H@wIkn6i'; // your database user's password
// $conn = mysql_connect ($dbhost,$dbuser,$dbpass,$db);
// $new= mysql_select_db("tester",$conn);
$conn = mysql_connect("glo1619909091678.db.9899235.hostedresource.com", "glo1619909091678", "r0H@wIkn6i")
...
<form onsubmit="return validateFormpopup()" method="post" action="<?php echo home_url(); ?>/?page_id=310" id="assesment" name="assesment_popup">

    <h3>Visa Assessment</h3>
    <div class="frrasse_bg">
        <div class="fr_txt"><span>01</span><p>Where do you live?</p></div>
        <div class="drp_dwn_pnl">
         <select id="living" class="drpDwnlst required" name="residingcountry">
    ...
    <div class="frrasse_bg1">
        ...
        <div class="drp_dwn_pnl">
            <select name="destinationcountry" id="select" class="drpDwnlst required">
...
function validateFormpopup() {
	var residing = document.forms["assesment_popup"]["residingcountry"].value;
	var destination = document.forms["assesment_popup"]["destinationcountry"].value;
...
<script>
    ...
    //      var url = "http://immigration-training.com/" ;
    //     window.location = url;
