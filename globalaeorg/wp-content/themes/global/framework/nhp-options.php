...
$args['menu_title'] = __('Global Options', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('Global Theme Options', 'nhp-opts');
...
foreach ( $pages as $key => $value )
{
	...
	$page_list[ $value->ID ] 	= $value->post_title;
...
$sections[] = array(
				...
				'desc' => __('<p class="description"> Here is site general options. </p>', 'nhp-opts'),
				//all the glyphicons are included in the options folder, so you can hook into them, or link to your own custom ones.
				//You dont have to though, leave it blank for default.
				...
				'fields' => array(
					array(
						...
						'desc' => __('Site name  here.', 'nhp-opts'),
					),
					array(
						'id' => 'site_logo',
						'type' => 'upload',
						'title' => __('Logo', 'nhp-opts'), 
						'sub_desc' => __('Website logo', 'nhp-opts'),
...
$sections[] = array(
				...
				'desc' => __('<p class="description"> Here is site header options. </p>', 'nhp-opts'),
				//all the glyphicons are included in the options folder, so you can hook into them, or link to your own custom ones.
				//You dont have to though, leave it blank for default.
				'icon' => NHP_OPTIONS_URL.'img/glyphicons/glyphicons_090_table.png',
				//Lets leave this as a blank section, no options just some intro text set above.
				'fields' => array(
					array(
						'id' => 'login_page_url',
						'type' => 'select',
						'title' => __('Login page', 'nhp-opts'), 
						'sub_desc' => __('Select login page from here.', 'nhp-opts'),
						// 'desc' => __('This is the description field, again good for additional info.', 'nhp-opts'),
						'options' => $page_list
					),
					array(
						...
						'sub_desc' => __('Header advertisement image', 'nhp-opts'),
						// 'desc' => __('This is the description field, again good for additional info.', 'nhp-opts')
					),
					array(
						'id' => 'header_image_2',
					...
					array(
						...
						// 'sub_desc' => __('This is a little space under the Field Title in the Options table, additonal info is good in here.', 'nhp-opts'),
						'desc' => __('Phone Number page url here.', 'nhp-opts'),
					),
					array(
						'id' => 'email_address',
						'type' => 'text',
						...
						// 'sub_desc' => __('This is a little space under the Field Title in the Options table, additonal info is good in here.', 'nhp-opts'),
						'desc' => __('Email Address page url here.', 'nhp-opts'),
					)
				)
			);
...
$sections[] = array(
				...
				//all the glyphicons are included in the options folder, so you can hook into them, or link to your own custom ones.
				//You dont have to though, leave it blank for default.
				'icon' => NHP_OPTIONS_URL.'img/glyphicons/glyphicons_329_e-mail.png',
				//Lets leave this as a blank section, no options just some intro text set above.
				'fields' => array(
					array(
						'id' => 'facebook',
						...
						// 'sub_desc' => __('This is a little space under the Field Title in the Options table, additonal info is good in here.', 'nhp-opts'),
						'desc' => __('Facebook page url here.', 'nhp-opts'),
					),
					array(
						'id' => 'linked_in',
						'type' => 'text',
						'title' => __('Linked In', 'nhp-opts'),
						// 'sub_desc' => __('This is a little space under the Field Title in the Options table, additonal info is good in here.', 'nhp-opts'),
						'desc' => __('Linked In page url here.', 'nhp-opts'),
					),
					array(
						'id' => 'twitter',
						'type' => 'text',
						...
						// 'sub_desc' => __('This is a little space under the Field Title in the Options table, additonal info is good in here.', 'nhp-opts'),
						'desc' => __('Twitter page url here.', 'nhp-opts'),
					)
				)
			);
