...
$dbuser='crm.globalmigrat'; // your database username   
$dbpass='globalmigrate.ae123!@#'; // your database user's password
$conn = mysql_connect ($dbhost,$dbuser,$dbpass,$db);
$new= mysql_select_db($db,$conn);
...
<form onsubmit="return validateForm()" method="post" action="<?php echo home_url(); ?>/?page_id=310" id="assesment" name="assesment">
