...
/*
* Template Name: Start Free Visa Assessment
*
*
*
*/
...
<div class="container">
    ...
    <div class="col-lg-4 col-sm-12 sidebar">
        <form method="post" action="<?php echo home_url(); ?>/?page_id=310" id="assesment" name="assesment">
            <h3>Visa Assessment</h3>
            <div class="frrasse_bg">
                <div class="fr_txt"><span>01</span><p>Where do you live?</p></div>
                <div class="drp_dwn_pnl">
                 <select id="living" class="drpDwnlst" name="residingcountry">
            ...
            <div class="frrasse_bg1">
                ...
                <div class="drp_dwn_pnl">
                   <select name="destinationcountry" id="select" class="drpDwnlst">
                <option value="" label="Select your country of choice" selected="selected">Select your country of choice</option>
                <option value="Australia">Australia</option><option value="2">Canada</option><option value="57">Denmark</option>
                <option value="United Kingdom">United Kingdom</option>
            ...
            <div class="button-back">
                <button onclick="abc()" name="go" class="btn green btn-primary go">Go</button> 

            </div>
        </form>
    </div>
    <div class="space" style="height:25px; float:left; width:100%;"></div>
</div>
