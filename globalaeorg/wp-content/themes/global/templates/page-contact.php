...
$map_data[] = unserialize( $meta['map_3'][0] );
...
<div class="col-md-8">
	...
	<div class="row">
		<h4><?php echo $meta['address_title_3'][0];?></h4>
		<div class="col-md-5">
			<p class="address-pad">
				<i class="fa fa-map-marker"></i><?php echo $meta['address_3'][0];?>
			</p>
			<p class="address-pad">
				<i class="fa fa-phone"></i><?php echo $meta['phone3'][0];?>
			</p>
			<!-- <p class="address-pad">
				<i class="fa fa-fax"></i><?php echo $meta['fax_3'][0];?>
			</p> -->
			<p class="address-pad">
				<i class="fa fa-envelope"></i><?php echo $meta['email_3'][0];?>
			</p>
		</div>
		<div class="col-md-7">
			<div class="acf-map">
				<div class="marker" data-lat="<?php echo $map_data[3]['lat']; ?>" data-lng="<?php echo $map_data[3]['lng']; ?>"></div>
			</div>
		</div>
	</div>
</div>
